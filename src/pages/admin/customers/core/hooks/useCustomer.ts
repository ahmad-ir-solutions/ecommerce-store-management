...
// import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query"
// import { useState } from "react"
// import { getSpecificCustomer, updateCustomer, deleteCustomer } from "../_request"
// import { ICustomer, UpdateCustomerData } from '../_modals'
// import { AddressFormValues, BasicDetailsFormValues } from '../_schema'
...
//     queryFn: () => getSpecificCustomer(customerId),
//     select: (data) => {
//       // Transform API response to match the Customer interface used in components
//       const customer = data.data
//       return {
...
//       } as ICustomer
//     },
//     enabled: !!customerId, // Only run if ID is provided
//   })
