              ...
              <div className="space-y-4">
                <div className="grid grid-cols-[1fr_1fr] items-center gap-4">
                  ...
                  <div>
                    <CustomSelect
                      ...
                      onChange={(value) => form.setValue("poShippingCostType", String(value))}
                      className="border-[#BBC2CB] bg-white max-w-52"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr_1fr] items-center gap-4">
                  ...
                  <div>
                    <CustomSelect
                      ...
                      onChange={(value) => form.setValue("poChangeToStatus", String(value))}
                      className="border-[#BBC2CB] bg-white max-w-52"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr_1fr] items-center gap-4">
                  ...
                  <Input
                    ...
                    type="number"
                    {...form.register("totalPoShippingCost", { valueAsNumber: true })}
                  />
                </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-[1fr_1fr] items-center gap-4">
                  ...
                  <div>
                    <CustomSelect
                      ...
                      onChange={(value) => form.setValue("dropShipShippingCostType", String(value))}
                      className="border-[#BBC2CB] bg-white max-w-52"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr_1fr] items-center gap-4">
                  ...
                  <div>
                    <CustomSelect
                      ...
                      onChange={(value) => form.setValue("dropShipChangeToStatus", String(value))}
                      className="border-[#BBC2CB] bg-white max-w-52"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[1fr_1fr] items-center gap-4">
                  ...
                  <Input
                    ...
                    type="number"
                    {...form.register("totalDropShipCost", { valueAsNumber: true })}
                  />
                </div>
